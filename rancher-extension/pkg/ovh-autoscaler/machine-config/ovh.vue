...
// OVH US Pricing - April 1, 2026 (updated from https://us.ovhcloud.com/public-cloud/prices/)
const FLAVORS = [
  // General Purpose (b3)
  { label: 'b3-8 (2 vCPU, 8GB) - $0.0605/hr', value: 'b3-8' },
  { label: 'b3-16 (4 vCPU, 16GB) - $0.1208/hr', value: 'b3-16' },
  { label: 'b3-32 (8 vCPU, 32GB) - $0.2415/hr', value: 'b3-32' },
  { label: 'b3-64 (16 vCPU, 64GB) - $0.4829/hr', value: 'b3-64' },
  { label: 'b3-128 (32 vCPU, 128GB) - $0.967/hr', value: 'b3-128' },
  { label: 'b3-256 (64 vCPU, 256GB) - $1.932/hr', value: 'b3-256' },
  // Compute Optimized (c3)
  { label: 'c3-4 (2 vCPU, 4GB) - $0.054/hr', value: 'c3-4' },
  { label: 'c3-8 (4 vCPU, 8GB) - $0.1078/hr', value: 'c3-8' },
  { label: 'c3-16 (8 vCPU, 16GB) - $0.2154/hr', value: 'c3-16' },
  { label: 'c3-32 (16 vCPU, 32GB) - $0.4307/hr', value: 'c3-32' },
  { label: 'c3-64 (32 vCPU, 64GB) - $0.8616/hr', value: 'c3-64' },
  { label: 'c3-128 (64 vCPU, 128GB) - $1.724/hr', value: 'c3-128' },
  // Memory Optimized (r3)
  { label: 'r3-16 (2 vCPU, 16GB) - $0.0783/hr', value: 'r3-16' },
  { label: 'r3-32 (4 vCPU, 32GB) - $0.1563/hr', value: 'r3-32' },
  { label: 'r3-64 (8 vCPU, 64GB) - $0.3125/hr', value: 'r3-64' },
  { label: 'r3-128 (16 vCPU, 128GB) - $0.626/hr', value: 'r3-128' },
  { label: 'r3-256 (32 vCPU, 256GB) - $1.25/hr', value: 'r3-256' },
  { label: 'r3-512 (64 vCPU, 512GB) - $2.50/hr', value: 'r3-512' },
];
